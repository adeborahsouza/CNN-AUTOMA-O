@ValidarRelatorioAgendamentoPorPlanoConvenio 
@Relatorios
@RelatoriosAgendamentos
@CNN_00022

Feature: Relatorio Agendamento Por Plano Convenio

  Scenario: CNN_00022_ValidarRelatorioAgendamentoPorPlanoConvenio
