@ValidarRelatorioAgendamentoPorCidadeAgendamento
@Relatorios
@RelatoriosAgendamentos
@CNN_00031

Feature: Relatorio Agendamento Por Cidade Agendamento

  Scenario: CNN_00031_ValidarRelatorioAgendamentoPorCidadeAgendamento
