@ValidarRelatorioAgendamentoPorProcedimentosAgendadosSintetico
@Relatorios
@RelatoriosAgendamentos
@CNN_00029

Feature: Relatorio Agendamento Por Procedimentos Agendados Sintetico

  Scenario: CNN_00029_ValidarRelatorioAgendamentoPorProcedimentosAgendadosSintetico
