@ValidarRelatorioAgendamentoRemarcacaoAnalitico
@Relatorios
@RelatoriosAgendamentos
@CNN_00035

Feature: Relatorio Agendamento Remarcacao Analitico

  Scenario: CNN_00035_ValidarRelatorioAgendamentoRemarcacaoAnalitico
