@ValidarRelatorioCriacaoAgendamentoSintetico 
@Relatorios
@RelatoriosAgendamentos
@CNN_00023

Feature: Relatorio Criacao Agendamento Sintetico

  Scenario: CNN_00023_ValidarRelatorioCriacaoAgendamentoSintetico
