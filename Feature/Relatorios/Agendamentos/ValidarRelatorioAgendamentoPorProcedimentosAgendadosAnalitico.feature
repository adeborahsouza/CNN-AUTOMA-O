@ValidarRelatorioAgendamentoPorProcedimentosAgendadosAnalitico
@Relatorios
@RelatoriosAgendamentos
@CNN_00030

Feature: Relatorio Agendamento Por Procedimentos Agendados Analitico

  Scenario: CNN_00030_ValidarRelatorioAgendamentoPorProcedimentosAgendadosAnalitico
