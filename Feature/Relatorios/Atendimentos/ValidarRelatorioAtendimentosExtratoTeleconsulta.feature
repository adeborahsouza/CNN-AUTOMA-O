@ValidarRelatorioAtendimentosExtratoTeleconsulta
@Relatorios
@RelatoriosAtendimentos
@CNN_00047

Feature: Validar Relatorio Atendimentos Extrato Teleconsulta

  Scenario: CNN_00047_ValidarRelatorioAtendimentosExtratoTeleconsulta
